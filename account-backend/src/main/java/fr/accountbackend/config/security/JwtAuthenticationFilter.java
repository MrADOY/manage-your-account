...
/**
 * Finally, Let’s write the JWTAuthenticationFilter to get the JWT token from the request, validate it, 
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    /**
     * In the above filter, We’re first parsing the JWT retrieved from the Authorization header of the request and obtaining the user’s Id. 
     ...
     * Note that, the database hit in the above filter is optional. You could also encode the user’s username and roles inside JWT claims 
